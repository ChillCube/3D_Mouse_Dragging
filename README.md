...
An addon that can be used to setup dragging items in 3D
...
```bash
clone-gd-addon https://github.com/ChillCube/3D_Mouse_Dragging.git
```
> [!IMPORTANT]
> Make sure to enable the addon, including its dependencies in the project settings!

## Documentation
You can find the documentation at: https://github.com/ChillCube/3D_Mouse_Dragging/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon 3D_Mouse_Dragging
```
